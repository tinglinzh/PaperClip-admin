...
export default function Login() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[url('@/assets/images/login-bg.png')] bg-contain bg-center bg-no-repeat">
      <div className="mx-auto flex min-w-[300px] rounded-md bg-white px-[24px] py-[20px] shadow-sm">
        <ProConfigProvider hashed={false}>
          <div style={{ backgroundColor: token.colorBgContainer }} className="flex w-full justify-center">
            <LoginForm
              logo={paperclipIcon}
              title={t('systemName')}
              actions={(
